...
def vehicle_data(csv, reg):
      ...
      # Update dataframe with entry for 1st registration date and 0 mileage and
...
def vehicle_plot(miles_df, car_dict):
      ...
      ax.set(xlabel="Date",
             ...
             # TODO fix/reorder index [0,-1] not [7,8]
